...
{
    public class CatInvoiceStatusConfig
    {
        /// <summary>
        /// Método que crea una tabla y asigna sus propiedades
        /// </summary>
        /// <param name="entityBuilder">Entidad para configurar</param>
        public static void SetEntityBuilder(EntityTypeBuilder<CatInvoiceStatusEntity> entityBuilder)
        {
            //Tabla a crear
            entityBuilder.ToTable("CatInvoiceStatus");
